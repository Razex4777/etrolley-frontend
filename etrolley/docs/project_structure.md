...
├── 📄 verification.html                   ( English Verification page; compiled from verification.base.html + verification component + navbar )
├── 📄 verification-ar.html                ( Arabic Verification page; RTL-compiled mirror with fully localized verification form )
├── 📄 registration.html                   ( English Registration page; compiled from registration.base.html + registration component + navbar )
├── 📄 registration-ar.html                ( Arabic Registration page; RTL-compiled mirror with fully localized registration form )
├── 📄 registration2.html                  ( English Registration V2 page; compiled from registration2.base.html + registration2 component + navbar )
├── 📄 registration2-ar.html               ( Arabic Registration V2 page; RTL-compiled mirror with fully localized pricing and coupon verification form )
├── 📄 registration3.html                  ( English Registration V3 page; compiled from registration3.base.html + registration3 component + navbar )
├── 📄 registration3-ar.html               ( Arabic Registration V3 page; RTL-compiled mirror with fully localized pricing, coupon verification, and domain warning form )
├── 📄 login.html                          ( English Login page; compiled from login.base.html + login component + navbar )
├── 📄 login-ar.html                       ( Arabic Login page; RTL-compiled mirror with fully localized login form )
├── 📄 vite.config.js                      ( Vite bundler config; multi-page entry for index, about, services, blog, designs, prices, faqs, create-store, contact, verification, registration, registration2, registration3, and login pages in both EN and AR )
│
...
└── 📁 src/                                ( All authored code lives here )
    ...
    ├── 📄 create-store.base.html          ( Base HTML shell layout template for compiled Create Store page )
    ├── 📄 verification.base.html          ( Base HTML shell layout template for compiled Verification page )
    ├── 📄 registration.base.html          ( Base HTML shell layout template for compiled Registration page )
    ├── 📄 registration2.base.html         ( Base HTML shell layout template for compiled Registration Step 2 page )
    ├── 📄 registration3.base.html         ( Base HTML shell layout template for compiled Registration Step 3 page )
    ├── 📄 login.base.html                 ( Base HTML shell layout template for compiled Login page )
    ├── 📁 components/                     ( UI building blocks; each contains its styles, static HTML layouts )
        ├── 📁 verification/               ( Localized phone verification code forms with dynamic digits autofocus and resend timer )
        ├── 📁 registration/               ( Localized store details creation form stretching to 838px full-width without right-side column )
        ├── 📁 registration2/              ( Localized pricing, coupon verification, and domain options form page with static graphics column )
        ├── 📁 registration3/              ( Localized pricing, coupon verification, domain options, and domain cost warning form page with static graphics column )
        ├── 📁 login/                      ( Localized login form page with static graphics column )
